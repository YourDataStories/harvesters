...
//			deyaResource.addProperty(Ontology.prefLabel, model.createLiteral(orgCatNames[1], "en"));
	...
	public void addKanonistikiToModel(Model model) {
		...
		List<String> regularList = Arrays.asList("Υπουργική Απόφαση", "Πράξη Γενικού Γραμματέα Αποκεντρωμένης Διοίκησης", "Πράξη Οργάνου Διοίκησης Ν.Π.Δ.Δ.", "Πράξη Οργάνου Διοίκησης ΟΤΑ Α’ και Β’ Βαθμού (και εποπτευόμενων φορέων τους)", "Λοιπές Κανονιστικές Πράξεις");
	...
	public void addPositionTypeToModel(Model model) {
		...
		List<String> positionList = Arrays.asList("Μονομελές Όργανο", "ΕΙΔΙΚΟΣ ΓΡΑΜΜΑΤΕΑΣ Σ.Δ.Ο.Ε.", "Γενικός Γραμματέας Υπουργείου");
	...
	public void addCollectiveKindToModel(Model model) {
		...
		List<String> colKindList = Arrays.asList("Παύση - Αντικατάσταση μέλους", "Συγκρότηση", "Καθορισμός Αμοιβής – Αποζημίωσης");
	...
	public void addAdminChangeToModel(Model model) {
		...
		List<String> changeList = Arrays.asList("Μετάταξη", "Λύση Υπαλληλικής Σχέσης", "Υποβιβασμός", "Αποδοχή Παραίτησης");
