...
//						+ Configuration.RESULTS_PER_PAGE + "&page=" + pageNumber;
	...
	public Organization searchOrganization(String orgId) {
		...
		try {
			...
			while (response == null) {
				// System.out.println("Retrieving the details of Organization "
				// + orgId + "...\n");
	 ...
	 * 
	 * @param String
	 *            the id of the investigated organization
	 ...
	 * @param String
	 *            the id of the investigated organization
	 * @return Signers an arraylist with the signers of the provided
	 *         organization
	 */
	 ...
	 * 
	 * @param String
	 *            the name of the investigated dictionary
	 * @return DictionaryItems an arraylist with the dictionary items as
	 *         provided by Di@vgeia
	 */
