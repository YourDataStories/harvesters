...
public class HandleApiRequests {
     ...
     */
	public List<Decision> searchDecisions(String dateToSearch) {
		...
		try {
			...
			while(!fetchedAll) { //while results exist
				...
				String query = "/search/advanced?q=(submissionTimestamp:[DT(" + dateToSearch + "T00:00:00) " +
							   "TO DT(" + dateToSearch + "T23:59:59)])" +
